...
|:---:|:---:|:---:|:---:|
| cpp  | 16 ms | 18.6 MB | 2022/10/29 23:55 |
...
public:
    int ans = 0;
    unordered_map<long, long> hs;
    void dfs(TreeNode* root, const long targetSum, long curr){
        if(!root) return;

        curr += root->val;
        if(hs.count(curr - targetSum)) ans += hs[curr - targetSum];
