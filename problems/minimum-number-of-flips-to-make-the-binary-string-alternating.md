...
## Tags - 题目标签
 ...
 <img src="https://img.shields.io/badge/Greedy-贪心-blue.svg">   <img src="https://img.shields.io/badge/String-字符串-blue.svg">   <img src="https://img.shields.io/badge/Dynamic Programming-动态规划-blue.svg">   <img src="https://img.shields.io/badge/Sliding Window-滑动窗口-blue.svg">  
...
[LeetCode](https://leetcode.com/problems/minimum-number-of-flips-to-make-the-binary-string-alternating/description/)  -  [LeetCode-CN](https://leetcode.cn/problems/minimum-number-of-flips-to-make-the-binary-string-alternating/description/)
## Latest Accepted Submissions - 最近一次 AC 的提交


| Language | Runtime | Memory | Submission Time |
|:---:|:---:|:---:|:---:|
| cpp  | 40 ms | 24.4 MB | 2023/01/14 21:26 |
...
public:
    int minFlips(string s) {
        ...
        int zero2OneCnt = 0, one2ZeroCnt = 0;
        ...
        while(j < 2 * n){
            if(j < n){
                for(; j < n; j++){
                    if(s[j] != zero2One[j]) zero2OneCnt++;
                    if(s[j] != one2Zero[j]) one2ZeroCnt++;
                }
                j--;
            }
            ans = min(ans, min(zero2OneCnt, one2ZeroCnt));
            // remove i
            if(s[i] != zero2One[i]) zero2OneCnt--;
            if(s[i] != one2Zero[i]) one2ZeroCnt--;
            i++;
