...
## Tags - 题目标签
 ...
 <img src="https://img.shields.io/badge/Array-数组-blue.svg">   <img src="https://img.shields.io/badge/Hash Table-哈希表-blue.svg">   <img src="https://img.shields.io/badge/Backtracking-回溯-blue.svg">   <img src="https://img.shields.io/badge/Matrix-矩阵-blue.svg">  
...
[LeetCode](https://leetcode.com/problems/sudoku-solver/description/)  -  [LeetCode-CN](https://leetcode.cn/problems/sudoku-solver/description/)
## Latest Accepted Submissions - 最近一次 AC 的提交


| Language | Runtime | Memory | Submission Time |
|:---:|:---:|:---:|:---:|
| cpp  | 24 ms | 6.2 MB | 2022/08/30 15:07 |

```cpp

class Solution {
public:
    bool isVaild(int row, int col, char c, vector<vector<char>>& board){
        for(int i = 0; i < 9; i++){
