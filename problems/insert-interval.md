...
[LeetCode](https://leetcode.com/problems/insert-interval/description/)  -  [LeetCode-CN](https://leetcode.cn/problems/insert-interval/description/)
## Latest Accepted Submissions - 最近一次 AC 的提交


| Language | Runtime | Memory | Submission Time |
|:---:|:---:|:---:|:---:|
| cpp  | 40 ms | 18 MB | 2023/01/04 10:46 |
...
public:
    vector<vector<int>> merge(vector<vector<int>>& intervals) {
        ...
        for(auto it = ll.begin(); it != ll.end(); it++){
            if(next(it, 1) == ll.end()) break;

            int startA = (*it)[0], endA = (*it)[1];
            int startB = (*next(it, 1))[0], endB = (*next(it, 1))[1];
