...
[LeetCode](https://leetcode.com/problems/string-compression/description/)  -  [LeetCode-CN](https://leetcode.cn/problems/string-compression/description/)
## Latest Accepted Submissions - 最近一次 AC 的提交


| Language | Runtime | Memory | Submission Time |
|:---:|:---:|:---:|:---:|
| cpp  | 4 ms | 8.6 MB | 2022/07/24 11:52 |
