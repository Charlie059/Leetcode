...
[LeetCode](https://leetcode.com/problems/find-largest-value-in-each-tree-row/description/)  -  [LeetCode-CN](https://leetcode.cn/problems/find-largest-value-in-each-tree-row/description/)
## Latest Accepted Submissions - 最近一次 AC 的提交


| Language | Runtime | Memory | Submission Time |
|:---:|:---:|:---:|:---:|
| cpp  | 16 ms | 21.8 MB | 2022/09/16 13:13 |
...
public:
    vector<int> largestValues(TreeNode* root) {
        ...
        while(!que.empty()){
            ...
            vec.emplace_back(*max_element(tmp.begin(), tmp.end()));
        }
        return vec;
    }
};
