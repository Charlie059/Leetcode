...
[LeetCode](https://leetcode.com/problems/pacific-atlantic-water-flow/description/)  -  [LeetCode-CN](https://leetcode.cn/problems/pacific-atlantic-water-flow/description/)
## Latest Accepted Submissions - 最近一次 AC 的提交


| Language | Runtime | Memory | Submission Time |
|:---:|:---:|:---:|:---:|
| cpp  | 24 ms | 25.1 MB | 2022/09/24 12:02 |
...
public:
    ...
    vector<vector<int>> pacificAtlantic(vector<vector<int>>& heights) {
        ...
        for(int i = 0; i < n; i++) dfs(heights, P, i, 0), dfs(heights, A, i, m - 1);
        for(int j = 0; j < m; j++) dfs(heights, P, 0, j), dfs(heights, A, n - 1, j);      
        return ans;  
    }
};
