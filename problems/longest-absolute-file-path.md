...
[LeetCode](https://leetcode.com/problems/longest-absolute-file-path/description/)  -  [LeetCode-CN](https://leetcode.cn/problems/longest-absolute-file-path/description/)
## Latest Accepted Submissions - 最近一次 AC 的提交


| Language | Runtime | Memory | Submission Time |
|:---:|:---:|:---:|:---:|
| cpp  | 0 ms | 6.3 MB | 2022/08/11 15:04 |
...
public:
    int lengthLongestPath(string input) {
        ...
        while(pos < n){
            ...
            while(st.size() >= deepth) st.pop();

            if(st.empty() == false) len += st.top() + 1;
