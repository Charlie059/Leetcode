...
## Tags - 题目标签
 ...
 <img src="https://img.shields.io/badge/Design-设计-blue.svg">   <img src="https://img.shields.io/badge/Segment Tree-线段树-blue.svg">   <img src="https://img.shields.io/badge/Binary Search-二分查找-blue.svg">   <img src="https://img.shields.io/badge/Ordered Set-有序集合-blue.svg">  
...
[LeetCode](https://leetcode.com/problems/my-calendar-i/description/)  -  [LeetCode-CN](https://leetcode.cn/problems/my-calendar-i/description/)
## Latest Accepted Submissions - 最近一次 AC 的提交


| Language | Runtime | Memory | Submission Time |
|:---:|:---:|:---:|:---:|
| cpp  | 72 ms | 37.8 MB | 2022/07/05 11:34 |
...
public:
    ...
    bool book(int start, int end) {
       auto it = data.lower_bound({end, 0});
        if (it == data.begin() || (--it)->second <= start) {
            data.emplace(start, end);
            return true;
        }
        return false;
    }
